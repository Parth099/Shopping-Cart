...
export default function UserCartCard(props) {
    ...
    return (
        <div className="item-container flex justify-between items-center py-4">
            <div className="img-container w-48">
                <img className="h-100 w-100" src={phoneData.image} alt={"An image of a phone, the phone is " + phoneData.name} />
            </div>
            <section className="info-container text-xl cart-font mr-12">
